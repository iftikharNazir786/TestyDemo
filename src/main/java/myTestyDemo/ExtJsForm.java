...
public class ExtJsForm extends Panel {
	...
	//Editor Grid Panel
	public Window PanelWindow = new Window("EditorGridPanel Win");
	public Window PanelWindow1 = new Window("EditableGrid");

	public Button close = new Button(PanelWindow, "Close");
	//public CheckBox CheckBox = new CheckBox(PanelWindow).setLabel("CatRight").setLabelPosition("//preceding-sibling::");
	public CheckBox CheckBox = new CheckBox(PanelWindow);

	//Tab Panel
	public Window TabPanel = new Window("TabPanel Win");
