...
/*
	...
	*/
	...
	public void textAreaTest() {
        ...
        System.out.println(eform.textArea.getText());
        System.out.println(eform.textArea.getTagName());
        System.out.println(eform.textArea.getXPath());
...
/*	
	...
	public void textFieldTest() {
		...
		public void simpleFormTest() throws InterruptedException, IOException {
			...
			//download
			 eform.downloadButton.download("Sana.docx");
			 // download File from Link
			 eform.downloadFileButton.download("Saba.docx");
			 // download File With Spaces
			 eform.downloadWithSpacesButton.download("Iftikhar t.docx");
			 ...
			 eform.uploadButton.upload(RESOURCES_DIRECTORY_PATH + "\\upload\\text.docx");
				...
				System.out.println(Projectpath+"/src/test/resources/upload/upload.exe");			
				ProcessBuilder pb = new ProcessBuilder(Projectpath+"/src/test/resources/upload/upload.exe", Projectpath+"\\src\\test\\resources\\upload\\text.docx");
				Thread.sleep(5000);
				pb.start();
				Thread.sleep(15000);
		}
		...
		@Test(priority=11)
		public void EditotGridPanelTest() {
			
			Button EditotGridPanel = new Button(null, "EditorGridPanel");
			EditotGridPanel.click();
			System.out.println(eform.PanelWindow1.getText());
			eform.CheckBox.click();
			eform.close.click();
			}
		...
		public void TabPanelTest() {
			...
			Button EditotGridPanel = new Button(null, "TabPanel");
			EditotGridPanel.click();
			}
*/
}
